...
<div class="content">
    ...
    <div class="contenu" style="color: #718096;">
        ...
        <p>
            Cliquer sur le lien si c'est vous voulez réinitialiser le mot de passe. Sinon ignorer ce message
        </p>

        <a href="{{$details['content']['lien']}}">Réinitialiser le mot passe</a>
